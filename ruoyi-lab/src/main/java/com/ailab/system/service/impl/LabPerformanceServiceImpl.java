...
public class LabPerformanceServiceImpl implements LabPerformanceService {
    ...
    public List<LabPerfScore> closePeriod(String period,String reason,Long actorUserId){
        ...
        String[] quarter=quarterRange(period); List<PerformanceAssetFact> assetFacts=safe(mapper.selectCriticalAssetFactsForUpdate(quarter[0],quarter[1])); Date cutoff=Date.from(clock.instant());
