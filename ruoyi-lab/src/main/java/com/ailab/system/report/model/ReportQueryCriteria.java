...
public final class ReportQueryCriteria {
    ...
    public String getPeriod() { return period; } public String getNextPeriod() { return nextPeriod; } public String getPerformancePeriod(){return reportPeriod.getKind()==ReportPeriod.Kind.QUARTER ? period.substring(0,4)+"-Q"+period.charAt(5) : period;} public String getMonthStart(){return monthStart;} public String getMonthEnd(){return monthEnd;} public Date getDateStart(){return new Date(dateStart.getTime());} public Date getDateEnd(){return new Date(dateEnd.getTime());} public ReportPeriod getReportPeriod(){return reportPeriod;} public ReportAccessScope getScope() { return scope; } public List<Filter> getFilters() { return filters; } public String getSort() { return sort; } public String getGroupBy() { return groupBy; }
