...
(31020,'新增目标',31002,1,'#','','','',1,0,'F','0','0','lab:goal:add','#','admin',NOW(),''),(31021,'编辑目标',31002,2,'#','','','',1,0,'F','0','0','lab:goal:edit','#','admin',NOW(),''),(31022,'删除目标',31002,3,'#','','','',1,0,'F','0','0','lab:goal:remove','#','admin',NOW(),''),(31023,'激活目标',31002,4,'#','','','',1,0,'F','0','0','lab:goal:activate','#','admin',NOW(),''),
