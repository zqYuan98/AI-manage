...
INSERT INTO `lab_task` (`id`,`parent_id`,`goal_id`,`milestone_id`,`task_level`,`period`,`biz_line`,`task_type`,`title`,`owner_id`,`dept_id`,`plan_date`,`actual_finish_time`,`deliverable`,`perf_weight`,`goal_weight`,`workflow_status`,`result_status`,`result_desc`,`fail_reason`,`next_action`,`asset_id`,`coordination_required`,`coordination_owner_id`,`coordination_dept_id`,`coordination_content`,`coordination_support`,`coordination_desc`,`current_block_flag`,`current_block_start`,`period_lock_flag`,`version`,`create_by`,`create_time`) VALUES (30001,0,30001,30002,'month','2026-08','algorithm','key','发布模型评测基准',30002,101,'2026-08-20',NULL,'评测看板',30,25,'PENDING_REVIEW','ONTIME','评测报告已提交',NULL,'完成质量门禁验收',30003,'1',30003,101,'平台指标支持','提供可观测数据','需要平台提供指标','0',NULL,'0',1,'admin',NOW()),(30002,30001,30001,30002,'week','2026-W32','algorithm','daily','优化评测提示词',30006,101,'2026-08-09','2026-08-07 16:00:00','提示词套件',10,8,'CONFIRMED','EXCEEDED','覆盖率提升 15%',NULL,'分享评测结论',30003,'0',NULL,NULL,NULL,NULL,NULL,'0',NULL,'0',1,'admin',NOW()),(30003,0,30001,30003,'month','2026-08','platform','key','发布模型服务 2.1 版本',30003,101,'2026-08-15',NULL,'发布说明',35,30,'ACTIVE','DOING','灰度部署进行中',NULL,'完成负载测试',30002,'1',30005,101,'可观测能力集成','开放指标访问','协调可观测能力','1','2026-08-06 09:00:00','0',1,'admin',NOW()),(30004,30003,30001,30003,'week','2026-W32','platform','daily','建设延迟监控看板',30005,101,'2026-08-08',NULL,'监控看板',12,8,'ACTIVE','DELAYED','等待指标标签确认','指标结构尚未统一','确认指标结构',30002,'1',30003,101,'指标结构评审','形成结构决策','评审指标结构','1','2026-08-05 10:00:00','0',1,'admin',NOW()),(30005,0,30001,30004,'month','2026-08','hardware','key','完成集群验收',30004,101,'2026-08-05','2026-08-04 15:00:00','签署验收单',28,25,'CONFIRMED','ONTIME','8 个节点全部通过验收',NULL,'归档验收证据',30001,'0',NULL,NULL,NULL,NULL,NULL,'0',NULL,'0',1,'admin',NOW());
