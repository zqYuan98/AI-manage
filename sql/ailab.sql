...
CREATE TABLE IF NOT EXISTS `lab_collaboration_record` (
 ...
 PRIMARY KEY (`id`), UNIQUE KEY `uk_lab_collab_idempotency` (`idempotency_key`,`idempotency_unique_flag`), KEY `idx_lab_collab_task` (`task_id`), KEY `idx_lab_collab_member_period_status` (`to_member_id`,`period`,`review_status`), KEY `idx_lab_collab_reviewer` (`reviewer_id`)
...
INSERT INTO `sys_role_menu` (`role_id`,`menu_id`) SELECT 30002,`menu_id` FROM `sys_menu` WHERE `menu_id` IN (31000,31001,31002,31003,31004,31005,31006,31007,31008,31009,31010,31011,31020,31021,31030,31031,31032,31033,31034,31070,31071,31072,31080,31081,31082,31092,31100,31110,31111,31112,31113);
INSERT INTO `sys_role_menu` (`role_id`,`menu_id`) SELECT 30003,`menu_id` FROM `sys_menu` WHERE `menu_id` IN (31000,31001,31002,31003,31004,31005,31006,31007,31008,31009,31011,31030,31031,31032,31033,31070,31071,31072,31080,31081,31082,31112);
