...
PREPARE ailab_ddl FROM @ailab_ddl; EXECUTE ailab_ddl; DEALLOCATE PREPARE ailab_ddl;
UPDATE `lab_report_section` SET `sensitive_flag`='1', `sensitive_permission`=COALESCE(NULLIF(TRIM(`sensitive_permission`),''),'lab:report:sensitive') WHERE `data_source`='PERF_SUMMARY' OR `sensitive_flag`='1';
...
INSERT INTO `lab_report_section` (`id`,`template_id`,`section_code`,`section_name`,`section_type`,`sort_no`,`data_source`,`query_config_json`,`render_config_json`,`style_config_json`,`manual_flag`,`visible_flag`,`sensitive_flag`,`sensitive_permission`,`version`,`create_by`,`create_time`) VALUES (30001,30001,'TASK_TABLE','Task delivery','TABLE',10,'TASK_DETAIL',JSON_OBJECT('filters',JSON_ARRAY(JSON_OBJECT('field','period','operator','EQ','value','${period}'))),JSON_OBJECT('columns',JSON_ARRAY('owner','status','deliverable')),JSON_OBJECT('width','100%'),'0','1','0',NULL,1,'admin',NOW()),(30002,30001,'SCORE_STAT','Performance overview','STAT',20,'TASK_STAT',JSON_OBJECT('filters',JSON_ARRAY(JSON_OBJECT('field','period','operator','EQ','value','${period}'))),JSON_OBJECT('metrics',JSON_ARRAY('average','top')),JSON_OBJECT(),'0','1','1','lab:report:sensitive',1,'admin',NOW()),(30003,30001,'MANAGER_TEXT','Manager narrative','TEXT',30,'GOAL_PROGRESS',JSON_OBJECT('filters',JSON_ARRAY()),JSON_OBJECT('template','Goal progress summary'),JSON_OBJECT(),'0','1','0',NULL,1,'admin',NOW()),(30004,30001,'MANUAL_NOTE','Manual note','MANUAL',40,NULL,JSON_OBJECT('filters',JSON_ARRAY()),JSON_OBJECT('placeholder','Enter management note'),JSON_OBJECT(),'1','1','0',NULL,1,'admin',NOW()),(30005,30001,'LINE_GROUP','Line updates','GROUP_TEXT',50,'TASK_COORD',JSON_OBJECT('filters',JSON_ARRAY()),JSON_OBJECT('groupBy','bizLine','template','line update'),JSON_OBJECT(),'0','1','0',NULL,1,'admin',NOW()),(30006,30001,'PROGRESS_CHART','Goal progress','CHART',60,'GOAL_PROGRESS',JSON_OBJECT('filters',JSON_ARRAY()),JSON_OBJECT('chart','bar'),JSON_OBJECT(),'0','1','0',NULL,1,'admin',NOW());
